...
- 📈 How quickly has internet adoption accelerated over time?
- 🌍 How does growth differ across income levels (low, middle, high income)?
- 📊 How did internet expansion compare between the **2000s** and the **2010s**?
---
#### 🛠️ Technologies Used
- Python 🐍
- Pandas
...
#### 🔍 Key Features
#### 🔹 Data Preparation
- Cleaned and structured multi-year country-level datasets
- Handled missing values and inconsistent records
- Filtered relevant indicators for analysis
